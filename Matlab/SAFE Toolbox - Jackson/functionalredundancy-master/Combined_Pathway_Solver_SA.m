...
function [total_FA,avg_chain,unsat_out] = Combined_Pathway_Solver_SA(enz_conc0)

%vector of model parameter values (fit values)
%p_vec = [a1 a2 a3 b1 c2 c1 c3 b2 b3 d1 d2 e f c4];
%p_vec = [1.0927    0.9573    1.1901    1.1881    0.9875    0.8898    0.9817    1.0778    0.3598    1.0642    0.9286    1.0791    1.2756    0.9756];
...
%Accounts for convention of having 0 ACC as first index of vector. 
enz_conc = [0 enz_conc0];
