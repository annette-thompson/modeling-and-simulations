function dy = Combined_Pathway_Model_FAEE(t,y,param_list,opt_struct,p_vec_k)
...
%FAEE production kinetic constants
%FadD
...
%WS
kcatWS = [0  0  0.004041608*p_vec_k(1)	0.003602158	0.004174775	0.004381183	0.004041608*p_vec_k(1)	0.003602158	0.004347892	0.003695375]; %doi.org/10.1074/jbc.M210533200
Km_FA_WS = 15.6; %doi.org/10.1074/jbc.M210533200

%Enzyme concentrations (uM)
WS = opt_struct.aux_enz(1);
FadD = opt_struct.aux_enz(2);

%TesA activity on acyl-CoAs
kcatTesA_CoA = 0*[param_list.kcat7(2:8) param_list.kcat7(5) param_list.kcat7(6) param_list.kcat7(7) param_list.kcat7(8)];
...
%FFA Production. 
dy(16,:) = kcat7(1).*y(101,:);
dy(21,:) = kcat7(2).*y(116,:) - kcatD1(1).*FadD.*y(1,:).*y(21,:)./((Km_ATP+y(1,:)).*(Km_FA(1)+y(21,:))) + kcatTesA_CoA(1).*e7.*y(337,:)./(Km_TesA_FA_CoA(1)+y(337,:));
dy(26,:) = kcat7(3).*y(131,:) - kcatD1(2).*FadD.*y(1,:).*y(26,:)./((Km_ATP+y(1,:)).*(Km_FA(2)+y(26,:))) + kcatTesA_CoA(2).*e7.*y(338,:)./(Km_TesA_FA_CoA(2)+y(338,:));
dy(31,:) = kcat7(4).*y(146,:) - kcatD1(3).*FadD.*y(1,:).*y(31,:)./((Km_ATP+y(1,:)).*(Km_FA(3)+y(31,:))) + kcatTesA_CoA(3).*e7.*y(339,:)./(Km_TesA_FA_CoA(3)+y(339,:));
dy(37,:) = kcat7(5).*y(161,:) - kcatD1(4).*FadD.*y(1,:).*y(37,:)./((Km_ATP+y(1,:)).*(Km_FA(4)+y(37,:))) + kcatTesA_CoA(4).*e7.*y(340,:)./(Km_TesA_FA_CoA(4)+y(340,:));
dy(47,:) = kcat7(6).*y(176,:) - kcatD1(5).*FadD.*y(1,:).*y(47,:)./((Km_ATP+y(1,:)).*(Km_FA(5)+y(47,:))) + kcatTesA_CoA(5).*e7.*y(341,:)./(Km_TesA_FA_CoA(5)+y(341,:));
dy(57,:) = kcat7(7).*y(191,:) - kcatD1(6).*FadD.*y(1,:).*y(57,:)./((Km_ATP+y(1,:)).*(Km_FA(6)+y(57,:))) + kcatTesA_CoA(6).*e7.*y(342,:)./(Km_TesA_FA_CoA(6)+y(342,:));
dy(67,:) = kcat7(8).*y(206,:) - kcatD1(7).*FadD.*y(1,:).*y(67,:)./((Km_ATP+y(1,:)).*(Km_FA(7)+y(67,:))) + kcatTesA_CoA(7).*e7.*y(343,:)./(Km_TesA_FA_CoA(7)+y(343,:));
dy(77,:) = kcat7(9).*y(221,:);

dy(42,:) = kcat7(5).*y(230,:) - kcatD1(8).*FadD.*y(1,:).*y(42,:)./((Km_ATP+y(1,:)).*(Km_FA(8)+y(42,:))) + kcatTesA_CoA(8).*e7.*y(344,:)./(Km_TesA_FA_CoA(8)+y(344,:));
dy(52,:) = kcat7(6).*y(245,:) - kcatD1(9).*FadD.*y(1,:).*y(52,:)./((Km_ATP+y(1,:)).*(Km_FA(9)+y(52,:))) + kcatTesA_CoA(9).*e7.*y(345,:)./(Km_TesA_FA_CoA(9)+y(345,:));
dy(62,:) = kcat7(7).*y(260,:) - kcatD1(10).*FadD.*y(1,:).*y(62,:)./((Km_ATP+y(1,:)).*(Km_FA(10)+y(62,:))) + kcatTesA_CoA(10).*e7.*y(346,:)./(Km_TesA_FA_CoA(10)+y(346,:));
dy(72,:) = kcat7(8).*y(275,:) - kcatD1(11).*FadD.*y(1,:).*y(72,:)./((Km_ATP+y(1,:)).*(Km_FA(11)+y(72,:))) + kcatTesA_CoA(11).*e7.*y(347,:)./(Km_TesA_FA_CoA(11)+y(347,:));
dy(82,:) = kcat7(9).*y(290,:);
...
%FAEE production pathway (FadD and WS)
...
dy(348,:) = kcatD2.*FadD.*y(9,:).*y(337,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(1)+y(337,:))) - kcatTesA_CoA(1).*e7.*y(348,:)./(Km_TesA_FA_CoA(1)+y(348,:));%6
dy(349,:) = kcatD2.*FadD.*y(9,:).*y(338,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(2)+y(338,:))) - kcatWS(1).*WS.*y(349,:)./((Km_FA_WS+y(349,:))) - kcatTesA_CoA(2).*e7.*y(349,:)./(Km_TesA_FA_CoA(2)+y(349,:));%8
dy(350,:) = kcatD2.*FadD.*y(9,:).*y(339,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(3)+y(339,:))) - kcatWS(2).*WS.*y(350,:)./((Km_FA_WS+y(350,:))) - kcatTesA_CoA(3).*e7.*y(350,:)./(Km_TesA_FA_CoA(3)+y(350,:));%10
dy(351,:) = kcatD2.*FadD.*y(9,:).*y(340,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(4)+y(340,:))) - kcatWS(3).*WS.*y(351,:)./((Km_FA_WS+y(351,:))) - kcatTesA_CoA(4).*e7.*y(351,:)./(Km_TesA_FA_CoA(4)+y(351,:));%12
dy(352,:) = kcatD2.*FadD.*y(9,:).*y(341,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(5)+y(341,:))) - kcatWS(4).*WS.*y(352,:)./((Km_FA_WS+y(352,:))) - kcatTesA_CoA(5).*e7.*y(352,:)./(Km_TesA_FA_CoA(5)+y(352,:));%14
dy(353,:) = kcatD2.*FadD.*y(9,:).*y(342,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(6)+y(342,:))) - kcatWS(5).*WS.*y(353,:)./((Km_FA_WS+y(353,:))) - kcatTesA_CoA(6).*e7.*y(353,:)./(Km_TesA_FA_CoA(6)+y(353,:));%16
dy(354,:) = kcatD2.*FadD.*y(9,:).*y(343,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(7)+y(343,:))) - kcatWS(6).*WS.*y(354,:)./((Km_FA_WS+y(354,:))) - kcatTesA_CoA(7).*e7.*y(354,:)./(Km_TesA_FA_CoA(7)+y(354,:));%18
dy(355,:) = kcatD2.*FadD.*y(9,:).*y(344,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(8)+y(344,:))) - kcatWS(7).*WS.*y(355,:)./((Km_FA_WS+y(355,:))) - kcatTesA_CoA(8).*e7.*y(355,:)./(Km_TesA_FA_CoA(8)+y(355,:));%12_unsat
dy(356,:) = kcatD2.*FadD.*y(9,:).*y(345,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(9)+y(345,:))) - kcatWS(8).*WS.*y(356,:)./((Km_FA_WS+y(356,:))) - kcatTesA_CoA(9).*e7.*y(356,:)./(Km_TesA_FA_CoA(9)+y(356,:));%14_unsat
dy(357,:) = kcatD2.*FadD.*y(9,:).*y(346,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(10)+y(346,:)))-kcatWS(9).*WS.*y(357,:)./((Km_FA_WS+y(357,:))) - kcatTesA_CoA(10).*e7.*y(357,:)./(Km_TesA_FA_CoA(10)+y(357,:));%16_unsat
dy(358,:) = kcatD2.*FadD.*y(9,:).*y(347,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(11)+y(347,:)))-kcatWS(10).*WS.*y(358,:)./((Km_FA_WS+y(358,:))) - kcatTesA_CoA(11).*e7.*y(358,:)./(Km_TesA_FA_CoA(11)+y(358,:));%18_unsat

%Production of FAEE (WS - atfA)
dy(359,:) = kcatWS(1).*WS.*y(349,:)./((Km_FA_WS+y(349,:)));%8
dy(360,:) = kcatWS(2).*WS.*y(350,:)./((Km_FA_WS+y(350,:)));%10
dy(361,:) = kcatWS(3).*WS.*y(351,:)./((Km_FA_WS+y(351,:)));%12
dy(362,:) = kcatWS(4).*WS.*y(352,:)./((Km_FA_WS+y(352,:)));%14
dy(363,:) = kcatWS(5).*WS.*y(353,:)./((Km_FA_WS+y(353,:)));%16
dy(364,:) = kcatWS(6).*WS.*y(354,:)./((Km_FA_WS+y(354,:)));%18
dy(365,:) = kcatWS(7).*WS.*y(355,:)./((Km_FA_WS+y(355,:)));%12_unsat
dy(366,:) = kcatWS(8).*WS.*y(356,:)./((Km_FA_WS+y(356,:)));%14_unsat
dy(367,:) = kcatWS(9).*WS.*y(357,:)./((Km_FA_WS+y(357,:)));%16_unsat
dy(368,:) = kcatWS(10).*WS.*y(358,:)./((Km_FA_WS+y(358,:)));%18_unsat
