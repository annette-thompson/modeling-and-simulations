function dy = Combined_Pathway_Model_Alk(t,y,param_list,opt_struct,p_vec_k)
...
%Alkane production kinetic constants
%AAR
%  10.1126/science.1187936
Km_FA = 8;
kcatC = [0.76/3600*0.354383752   0.76/3600*2.886373895  0.76/3600*p_vec_k(1)  0.76/3600*0.354383752  0.76/3600*0.195807526  0.76/3600];
Km_AAR_NADPH = 8;


%ADO 
%doi.org/10.1073/pnas.1218769110
kcatAdo = [.65/60  0.65/60  0  0.68/60];
Km_FA_Ado = [30  41  440  44];

%Enzyme concentrations (uM)
AAR = opt_struct.aux_enz(1);
Ado = opt_struct.aux_enz(2);
...
dy(4,:) = k2_3r.*y(89,:) - k2_3f.*y(88,:).*y(4,:)...
    ...
    + kcatC(1).*AAR.*y(46,:).*y(6,:)./((Km_FA+y(46,:)).*(Km_AAR_NADPH+y(6,:)))...
    + kcatC(2).*AAR.*y(56,:).*y(6,:)./((Km_FA+y(56,:)).*(Km_AAR_NADPH+y(6,:)))...
    + kcatC(3).*AAR.*y(66,:).*y(6,:)./((Km_FA+y(66,:)).*(Km_AAR_NADPH+y(6,:)))...
    + kcatC(4).*AAR.*y(51,:).*y(6,:)./((Km_FA+y(51,:)).*(Km_AAR_NADPH+y(6,:)))...
    + kcatC(5).*AAR.*y(61,:).*y(6,:)./((Km_FA+y(61,:)).*(Km_AAR_NADPH+y(6,:)))...
    + kcatC(6).*AAR.*y(71,:).*y(6,:)./((Km_FA+y(71,:)).*(Km_AAR_NADPH+y(6,:)))...
    ;
...
dy(46,:) =  kcat6(6).*y(175,:)+ k7_1r(6).*y(176,:)+ k8_1r(6).*y(177,:)+ k10_1r(6).*y(182,:) - k7_1f(6).*e7.*y(46,:)- k8_1f(6).*e8.*y(46,:)- k10_1f(6).*e10.*y(46,:)- k3_4f(6).*e3.*y(46,:)+ k3_4r(6).*y(170,:)- k3_5f(6).*y(91,:).*y(46,:)+ k3_5r(6).*y(171,:)...
            -A_kcat8.*LpxM.*y(317,:).*y(46,:)./((Km4+y(317,:).*(km_myr+y(46,:)))) - kcatC(1).*AAR.*y(46,:).*y(6,:)./((Km_FA+y(46,:)).*(Km_AAR_NADPH+y(6,:)));
dy(56,:) =  kcat6(7).*y(190,:)+ k7_1r(7).*y(191,:)+ k8_1r(7).*y(192,:)+ k10_1r(7).*y(197,:) - k7_1f(7).*e7.*y(56,:)- k8_1f(7).*e8.*y(56,:)- k10_1f(7).*e10.*y(56,:)- k3_4f(7).*e3.*y(56,:)+ k3_4r(7).*y(185,:)- k3_5f(7).*y(91,:).*y(56,:)+ k3_5r(7).*y(186,:)...
            -kcatP1.*PlsB.*G3P.*y(56,:)./((KmP1+G3P).*(KmP2+y(56,:))) - kcatC(2).*AAR.*y(56,:).*y(6,:)./((Km_FA+y(56,:)).*(Km_AAR_NADPH+y(6,:)));
...
dy(61,:) =  kcat6(7).*y(259,:)+ k7_1r(7).*y(260,:)+ k8_1r(7).*y(261,:)+ k10_1r(7).*y(266,:) - k7_1f(7).*e7.*y(61,:)- k8_1f(7).*e8.*y(61,:)- k10_1f(7).*e10.*y(61,:)- k3_4f(7).*e3.*y(61,:)+ k3_4r(7).*y(254,:)- k3_5f(7).*y(91,:).*y(61,:)+ k3_5r(7).*y(255,:)...
            -kcatP2*PlsC.*y(324,:).*y(61,:)./((KmP4 + y(324,:)).*(KmP5 + y(61,:))) - kcatC(5).*AAR.*y(61,:).*y(6,:)./((Km_FA+y(61,:)).*(Km_AAR_NADPH+y(6,:)));
dy(71,:) =  kcat6(8).*y(274,:)+ k7_1r(8).*y(275,:)+ k8_1r(8).*y(276,:)+ k10_1r(8).*y(281,:) - k7_1f(8).*e7.*y(71,:)- k8_1f(8).*e8.*y(71,:)- k10_1f(8).*e10.*y(71,:)- k3_4f(8).*e3.*y(71,:)+ k3_4r(8).*y(269,:)- k3_5f(8).*y(91,:).*y(71,:)+ k3_5r(8).*y(270,:)...
            -kcatP1.*PlsB.*G3P.*y(71,:)./((KmP1+G3P).*(KmP3+y(71,:))) - kcatP2*PlsC.*y(324,:).*y(71,:)./((KmP4 + y(324,:)).*(KmP6 + y(71,:))) - kcatC(6).*AAR.*y(71,:).*y(6,:)./((Km_FA+y(71,:)).*(Km_AAR_NADPH+y(6,:)));
...
%Alkane Production Pathways AAR and Ado
dy(337,:) = kcatC(1).*AAR.*y(46,:).*y(6,:)./((Km_FA+y(46,:)).*(Km_AAR_NADPH+y(6,:)));%14
dy(338,:) = kcatC(2).*AAR.*y(56,:).*y(6,:)./((Km_FA+y(56,:)).*(Km_AAR_NADPH+y(6,:))) - kcatAdo(1).*Ado.*y(338,:)./((Km_FA_Ado(1)+y(338,:)));%16
dy(339,:) = kcatC(3).*AAR.*y(66,:).*y(6,:)./((Km_FA+y(66,:)).*(Km_AAR_NADPH+y(6,:))) - kcatAdo(2).*Ado.*y(339,:)./((Km_FA_Ado(2)+y(339,:)));%18
dy(340,:) = kcatC(4).*AAR.*y(51,:).*y(6,:)./((Km_FA+y(51,:)).*(Km_AAR_NADPH+y(6,:)));%14_unsat
dy(341,:) = kcatC(5).*AAR.*y(61,:).*y(6,:)./((Km_FA+y(61,:)).*(Km_AAR_NADPH+y(6,:))) - kcatAdo(3).*Ado.*y(341,:)./((Km_FA_Ado(3)+y(341,:)));%16_unsat
dy(342,:) = kcatC(6).*AAR.*y(71,:).*y(6,:)./((Km_FA+y(71,:)).*(Km_AAR_NADPH+y(6,:))) - kcatAdo(4).*Ado.*y(342,:)./((Km_FA_Ado(4)+y(342,:)));%18_unsat

%Prodctuion of alkanes
dy(343,:) = kcatAdo(1).*Ado.*y(338,:)./((Km_FA_Ado(1)+y(338,:)));%15
dy(344,:) = kcatAdo(2).*Ado.*y(339,:)./((Km_FA_Ado(2)+y(339,:)));%17
dy(345,:) = kcatAdo(3).*Ado.*y(341,:)./((Km_FA_Ado(3)+y(341,:)));%15_unsat
dy(346,:) = kcatAdo(4).*Ado.*y(342,:)./((Km_FA_Ado(4)+y(342,:)));%17_unsat
