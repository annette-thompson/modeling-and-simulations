function dy = Combined_Pathway_Model_Ket(t,y,param_list,opt_struct)
...
dy(348,:) = kcatD2.*FadD.*y(9,:).*y(337,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(1)+y(337,:))) - kcatE.*FadE.*FAD.*y(348,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(348,:))) - kcatTesA_CoA(1).*e7.*y(348,:)./(Km_TesA_FA_CoA(1)+y(348,:));%6
dy(349,:) = kcatD2.*FadD.*y(9,:).*y(338,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(2)+y(338,:))) - kcatE.*FadE.*FAD.*y(349,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(349,:))) - kcatTesA_CoA(2).*e7.*y(349,:)./(Km_TesA_FA_CoA(2)+y(349,:));%8
dy(350,:) = kcatD2.*FadD.*y(9,:).*y(339,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(3)+y(339,:))) - kcatE.*FadE.*FAD.*y(350,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(350,:))) - kcatTesA_CoA(3).*e7.*y(350,:)./(Km_TesA_FA_CoA(3)+y(350,:));%10
dy(351,:) = kcatD2.*FadD.*y(9,:).*y(340,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(4)+y(340,:))) - kcatE.*FadE.*FAD.*y(351,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(351,:))) - kcatTesA_CoA(4).*e7.*y(351,:)./(Km_TesA_FA_CoA(4)+y(351,:));%12
dy(352,:) = kcatD2.*FadD.*y(9,:).*y(341,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(5)+y(341,:))) - kcatE.*FadE.*FAD.*y(352,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(352,:))) - kcatTesA_CoA(5).*e7.*y(352,:)./(Km_TesA_FA_CoA(5)+y(352,:));%14
dy(353,:) = kcatD2.*FadD.*y(9,:).*y(342,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(6)+y(342,:))) - kcatE.*FadE.*FAD.*y(353,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(353,:))) - kcatTesA_CoA(6).*e7.*y(353,:)./(Km_TesA_FA_CoA(6)+y(353,:));%16
dy(354,:) = kcatD2.*FadD.*y(9,:).*y(343,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(7)+y(343,:))) - kcatE.*FadE.*FAD.*y(354,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(354,:))) - kcatTesA_CoA(7).*e7.*y(354,:)./(Km_TesA_FA_CoA(7)+y(354,:));%18
dy(355,:) = kcatD2.*FadD.*y(9,:).*y(344,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(8)+y(344,:))) - kcatE.*FadE.*FAD.*y(355,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(355,:))) - kcatTesA_CoA(8).*e7.*y(355,:)./(Km_TesA_FA_CoA(8)+y(355,:));%12_unsat
dy(356,:) = kcatD2.*FadD.*y(9,:).*y(345,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(9)+y(345,:))) - kcatE.*FadE.*FAD.*y(356,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(356,:))) - kcatTesA_CoA(9).*e7.*y(356,:)./(Km_TesA_FA_CoA(9)+y(356,:));%14_unsat
dy(357,:) = kcatD2.*FadD.*y(9,:).*y(346,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(10)+y(346,:))) - kcatE.*FadE.*FAD.*y(357,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(357,:))) - kcatTesA_CoA(10).*e7.*y(357,:)./(Km_TesA_FA_CoA(10)+y(357,:));%16_unsat
dy(358,:) = kcatD2.*FadD.*y(9,:).*y(347,:)./((Km_CoA+y(9,:)).*(Km_FA_AMP(11)+y(347,:))) - kcatE.*FadE.*FAD.*y(358,:)./((Km_FAD+FAD).*(Km_FA_CoA+y(358,:))) - kcatTesA_CoA(11).*e7.*y(358,:)./(Km_TesA_FA_CoA(11)+y(358,:));%18_unsat
...
dy(382,:) = kcatB2.*FadB.*NAD.*y(371,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(371,:))) - kcatM(2).*FadM.*y(382,:)./(Km_FadM_keto_acyl_CoA(2)+y(382,:));%8
dy(383,:) = kcatB2.*FadB.*NAD.*y(372,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(372,:))) - kcatM(3).*FadM.*y(383,:)./(Km_FadM_keto_acyl_CoA(3)+y(383,:));%10
dy(384,:) = kcatB2.*FadB.*NAD.*y(373,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(373,:))) - kcatM(4).*FadM.*y(384,:)./(Km_FadM_keto_acyl_CoA(4)+y(384,:));%12
dy(385,:) = kcatB2.*FadB.*NAD.*y(374,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(374,:))) - kcatM(5).*FadM.*y(385,:)./(Km_FadM_keto_acyl_CoA(5)+y(385,:));%14
dy(386,:) = kcatB2.*FadB.*NAD.*y(375,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(375,:))) - kcatM(6).*FadM.*y(386,:)./(Km_FadM_keto_acyl_CoA(6)+y(386,:));%16
dy(387,:) = kcatB2.*FadB.*NAD.*y(376,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(376,:))) - kcatM(7).*FadM.*y(387,:)./(Km_FadM_keto_acyl_CoA(7)+y(387,:));%18
dy(388,:) = kcatB2.*FadB.*NAD.*y(377,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(377,:))) - kcatM(8).*FadM.*y(388,:)./(Km_FadM_keto_acyl_CoA(8)+y(388,:));%12_unsat
dy(389,:) = kcatB2.*FadB.*NAD.*y(378,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(378,:))) - kcatM(9).*FadM.*y(389,:)./(Km_FadM_keto_acyl_CoA(9)+y(389,:));%14_unsat
dy(390,:) = kcatB2.*FadB.*NAD.*y(379,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(379,:))) - kcatM(10).*FadM.*y(390,:)./(Km_FadM_keto_acyl_CoA(10)+y(390,:));%16_unsat
dy(391,:) = kcatB2.*FadB.*NAD.*y(380,:)./((Km_NAD+NAD).*(Km_hyd_acyl_CoA+y(380,:))) - kcatM(11).*FadM.*y(391,:)./(Km_FadM_keto_acyl_CoA(11)+y(391,:));%18_unsat
...
dy(392,:) = kcatM(1).*FadM.*y(381,:)./(Km_FadM_keto_acyl_CoA(1)+y(381,:)) + kcatM_ACP(1).*FadM.*y(17,:)./(Km_FadM_keto_acyl_CoA(1)+y(17,:));%6
dy(393,:) = kcatM(2).*FadM.*y(382,:)./(Km_FadM_keto_acyl_CoA(2)+y(382,:)) + kcatM_ACP(2).*FadM.*y(22,:)./(Km_FadM_keto_acyl_CoA(2)+y(22,:));%8
dy(394,:) = kcatM(3).*FadM.*y(383,:)./(Km_FadM_keto_acyl_CoA(3)+y(383,:)) + kcatM_ACP(3).*FadM.*y(27,:)./(Km_FadM_keto_acyl_CoA(3)+y(27,:));%10
dy(395,:) = kcatM(4).*FadM.*y(384,:)./(Km_FadM_keto_acyl_CoA(4)+y(384,:)) + kcatM_ACP(4).*FadM.*y(33,:)./(Km_FadM_keto_acyl_CoA(4)+y(33,:));%12
dy(396,:) = kcatM(5).*FadM.*y(385,:)./(Km_FadM_keto_acyl_CoA(5)+y(385,:)) + kcatM_ACP(5).*FadM.*y(43,:)./(Km_FadM_keto_acyl_CoA(5)+y(43,:));%14
dy(397,:) = kcatM(6).*FadM.*y(386,:)./(Km_FadM_keto_acyl_CoA(6)+y(386,:)) + kcatM_ACP(6).*FadM.*y(53,:)./(Km_FadM_keto_acyl_CoA(6)+y(53,:));%16
dy(398,:) = kcatM(7).*FadM.*y(387,:)./(Km_FadM_keto_acyl_CoA(7)+y(387,:)) + kcatM_ACP(7).*FadM.*y(63,:)./(Km_FadM_keto_acyl_CoA(7)+y(63,:));%18
dy(399,:) = kcatM(8).*FadM.*y(388,:)./(Km_FadM_keto_acyl_CoA(8)+y(388,:)) + kcatM_ACP(8).*FadM.*y(38,:)./(Km_FadM_keto_acyl_CoA(8)+y(38,:));%12_unsat
dy(400,:) = kcatM(9).*FadM.*y(389,:)./(Km_FadM_keto_acyl_CoA(9)+y(389,:)) + kcatM_ACP(9).*FadM.*y(48,:)./(Km_FadM_keto_acyl_CoA(9)+y(48,:));%14_unsat
dy(401,:) = kcatM(10).*FadM.*y(390,:)./(Km_FadM_keto_acyl_CoA(10)+y(390,:)) + kcatM_ACP(10).*FadM.*y(58,:)./(Km_FadM_keto_acyl_CoA(10)+y(58,:));%16_unsat
dy(402,:) = kcatM(11).*FadM.*y(391,:)./(Km_FadM_keto_acyl_CoA(11)+y(391,:)) + kcatM_ACP(11).*FadM.*y(68,:)./(Km_FadM_keto_acyl_CoA(11)+y(68,:));%18_unsat
