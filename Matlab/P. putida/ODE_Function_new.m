function dcdt = ODE_Function_new(t,c,P)
...
% Bicarbonate
d_Bicarbonate = P.k1_2r.*c_ACC_s2 - P.k1_2f.*c_ACC_s1.*c_Bicarbonate;

% C2n (n=1:9)-CoA %changed 
d_AcCoA       = P.k3_1r(1).*c_C2_FabH_CoA   - P.k3_1f(1).*c_FabH.*c_AcCoA + P.k1_3r.*c_ACC_s4 - P.k1_3f.*c_ACC_s3.*c_AcCoA + P.k8_4r.*c_FabF_AcCoA - P.k8_4f.*c_FabF.*c_AcCoA + P.k10_4r.*c_FabB_AcCoA - P.k10_4f.*c_FabB.*c_AcCoA;
d_SucCoA     = P.k3_1r(2).*c_C4_FabH_CoA   - P.k3_1f(2).*c_FabH.*c_SucCoA;
d_HexCoA     = P.k3_1r(3).*c_C6_FabH_CoA   - P.k3_1f(3).*c_FabH.*c_HexCoA;
d_OcCoA      = P.k3_1r(4).*c_C8_FabH_CoA   - P.k3_1f(4).*c_FabH.*c_OcCoA;
d_DecCoA    = P.k3_1r(5).*c_C10_FabH_CoA  - P.k3_1f(5).*c_FabH.*c_DecCoA;
d_LauCoA     = P.k3_1r(6).*c_C12_FabH_CoA - P.k3_1f(6).*c_FabH.*c_LauCoA;
d_EthCoA     = P.k3_1r(7).*c_C14_FabH_CoA  - P.k3_1f(7).*c_FabH.*c_EthCoA;
d_PalCoA      = P.k3_1r(8).*c_C16_FabH_CoA - P.k3_1f(8).*c_FabH.*c_PalCoA;
d_OcDecCoA = P.k3_1r(9).*c_C18_FabH_CoA - P.k3_1f(9).*c_FabH.*c_OcDecCoA;

% ACP
d_ACP = P.k2_3r.*c_FabD_Act_ACP - P.k2_3f.*c_FabD_Act.*c_ACP...
...
% ADP
d_ADP = P.kcat1_2.*c_ACC_s4;

% Malonyl-CoA
d_MalCoA = P.kcat1_2.*c_ACC_s4 + P.k2_1r.*c_FabD_MalCoA - P.k2_1f.*c_FabD.*c_MalCoA; 

% CoA %changed
d_CoA = P.k2_2f.*c_FabD_MalCoA - P.k2_2r.*c_FabD_Act.*c_CoA...
    ...
    + P.k8_5f.*c_FabF_AcCoA   - P.k8_5r*c_C2_FabF_Act.*c_CoA...
    + P.k10_5f.*c_FabB_AcCoA - P.k10_5r.*c_C2_FabB_Act.*c_CoA;

% Malonyl-ACP %changed
d_MalACP = P.k2_4f.*c_FabD_Act_ACP - P.k2_4r.*c_FabD.*c_MalACP...
    ...
    + P.k10_6r.*c_C2_FabB_Act_MalACP - P.k10_6f.*c_C2_FabB_Act.*c_MalACP...
    + P.k8_7r.*c_FabF_MalACP   - P.k8_7f.*c_FabF.*c_MalACP...
    + P.k10_7r.*c_FabB_MalACP - P.k10_7f.*c_FabB.*c_MalACP;

% CO2 %changed
d_CO2 = P.kcat3(1).*c_C2_FabH_Act_MalACP + P.kcat3(2).*c_C4_FabH_Act_MalACP + P.kcat3(3).*c_C6_FabH_Act_MalACP + P.kcat3(4).*c_C8_FabH_Act_MalACP...
    ...
    + P.kcat8_H.*c_C2_FabF_Act_MalACP + P.kcat8_CO2.*c_FabF_MalACP...
    + P.kcat10_H.*c_C2_FabB_Act_MalACP + P.kcat10_CO2.*c_FabB_MalACP;

% C2n (n=2:10) B-ketoacyl-ACPs (FabH + FabF + FabB - FabG) %changed
d_C4_BKeACP    = P.kcat3(1).*c_C2_FabH_Act_MalACP   + P.kcat8_H.*c_C2_FabF_Act_MalACP   + P.kcat10_H.*c_C2_FabB_Act_MalACP         + P.k4_2r(1).*c_C4_FabG_NADPH_BKeACP   - P.k4_2f(1).*c_FabG_NADPH.*c_C4_BKeACP;
...
% ACC Step 1
d_ACC_s1 = P.k1_1f.*c_ACC.*c_ATP - P.k1_1r.*c_ACC_s1 + P.k1_2r.*c_ACC_s2 - P.k1_2f.*c_ACC_s1.*c_Bicarbonate;

% ACC Step 2
d_ACC_s2 = P.k1_2f.*c_ACC_s1.*c_Bicarbonate - P.k1_2r.*c_ACC_s2 - P.kcat1_1.*c_ACC_s2;

% ACC Step 3
d_ACC_s3 = P.kcat1_1.*c_ACC_s2 + P.k1_3r.*c_ACC_s4 - P.k1_3f.*c_ACC_s3.*c_AcCoA;

% ACC Step 4
d_ACC_s4 = P.k1_3f.*c_ACC_s3.*c_AcCoA - P.k1_3r.*c_ACC_s4 - P.kcat1_2.*c_ACC_s4;

% FabD-Malonyl-CoA
d_FabD_MalCoA = P.k2_1f.*c_FabD.*c_MalCoA - P.k2_1r.*c_FabD_MalCoA + P.k2_2r.*c_FabD_Act.*c_CoA - P.k2_2f.*c_FabD_MalCoA; 

% FabD*
d_FabD_Act = P.k2_2f.*c_FabD_MalCoA - P.k2_2r.*c_FabD_Act.*c_CoA + P.k2_3r.*c_FabD_Act_ACP - P.k2_3f.*c_FabD_Act.*c_ACP;

% FabD*-ACP
d_FabD_Act_ACP = P.k2_3f.*c_FabD_Act.*c_ACP - P.k2_3r.*c_FabD_Act_ACP + P.k2_4r.*c_FabD.*c_MalACP - P.k2_4f.*c_FabD_Act_ACP;

% C2n (n=1:9) FabH-CoA %changed
d_C2_FabH_CoA   = P.k3_1f(1).*c_FabH.*c_AcCoA      - P.k3_1r(1).*c_C2_FabH_CoA   + P.k3_2r(1).*c_C2_FabH_Act.*c_CoA   - P.k3_2f(1).*c_C2_FabH_CoA; 
d_C4_FabH_CoA   = P.k3_1f(1).*c_FabH.*c_SucCoA    - P.k3_1r(2).*c_C4_FabH_CoA   + P.k3_2r(2).*c_C4_FabH_Act.*c_CoA   - P.k3_2f(2).*c_C4_FabH_CoA; 
d_C6_FabH_CoA   = P.k3_1f(1).*c_FabH.*c_HexCoA    - P.k3_1r(3).*c_C6_FabH_CoA   + P.k3_2r(3).*c_C6_FabH_Act.*c_CoA   - P.k3_2f(3).*c_C6_FabH_CoA; 
d_C8_FabH_CoA   = P.k3_1f(1).*c_FabH.*c_OcCoA      - P.k3_1r(4).*c_C8_FabH_CoA   + P.k3_2r(4).*c_C8_FabH_Act.*c_CoA   - P.k3_2f(4).*c_C8_FabH_CoA; 
d_C10_FabH_CoA = P.k3_1f(1).*c_FabH.*c_DecCoA    - P.k3_1r(5).*c_C10_FabH_CoA  + P.k3_2r(5).*c_C10_FabH_Act.*c_CoA - P.k3_2f(5).*c_C10_FabH_CoA; 
d_C12_FabH_CoA = P.k3_1f(1).*c_FabH.*c_LauCoA     - P.k3_1r(6).*c_C12_FabH_CoA + P.k3_2r(6).*c_C12_FabH_Act.*c_CoA - P.k3_2f(6).*c_C12_FabH_CoA;
d_C14_FabH_CoA = P.k3_1f(1).*c_FabH.*c_EthCoA     - P.k3_1r(7).*c_C14_FabH_CoA + P.k3_2r(7).*c_C14_FabH_Act.*c_CoA - P.k3_2f(7).*c_C14_FabH_CoA; 
d_C16_FabH_CoA = P.k3_1f(1).*c_FabH.*c_PalCoA     - P.k3_1r(8).*c_C16_FabH_CoA  + P.k3_2r(8).*c_C16_FabH_Act.*c_CoA - P.k3_2f(8).*c_C16_FabH_CoA; 
d_C18_FabH_CoA = P.k3_1f(1).*c_FabH.*c_OcDecCoA - P.k3_1r(9).*c_C18_FabH_CoA + P.k3_2r(9).*c_C18_FabH_Act.*c_CoA - P.k3_2f(9).*c_C18_FabH_CoA; 
...
% FabB-Acetyl-CoA
d_FabB_AcCoA = P.k10_4f.*c_FabB.*c_AcCoA - P.k10_4r.*c_FabB_AcCoA + P.k10_5r.*c_C2_FabB_Act.*c_CoA - P.k10_5f.*c_FabB_AcCoA;

% FabB*
d_C2_FabB_Act = P.k10_5f.*c_FabB_AcCoA - P.k10_5r.*c_C2_FabB_Act.*c_CoA + P.k10_6r.*c_C2_FabB_Act_MalACP - P.k10_6f.*c_C2_FabB_Act.*c_MalACP + P.k10_9f.*c_C2_FabB_AcACP - P.k10_9r.*c_C2_FabB_Act.*c_ACP;

% FabB*-Malonyl-ACP
d_C2_FabB_Act_MalACP = P.k10_6f.*c_C2_FabB_Act.*c_MalACP - P.k10_6r.*c_C2_FabB_Act_MalACP - P.kcat10_H.*c_C2_FabB_Act_MalACP; 

% Giving FabF FabH-like activity
% FabF-Acetyl-CoA
d_FabF_AcCoA = P.k8_4f.*c_FabF.*c_AcCoA - P.k8_4r.*c_FabF_AcCoA + P.k8_5r.*c_C2_FabF_Act.*c_CoA - P.k8_5f.*c_FabF_AcCoA; 

% FabF*
d_C2_FabF_Act = P.k8_5f.*c_FabF_AcCoA - P.k8_5r.*c_C2_FabF_Act.*c_CoA + P.k8_6r.*c_C2_FabF_Act_MalACP - P.k8_6f.*c_C2_FabF_Act.*c_MalACP + P.k8_9f.*c_C2_FabF_AcACP - P.k8_9r.*c_C2_FabF_Act.*c_ACP; 
...
d_FabB_MalACP = P.k10_7f.*c_FabB.*c_MalACP - P.k10_7r.*c_FabB_MalACP - P.kcat10_CO2.*c_FabB_MalACP;

% Acetyl-ACP (T_2)
d_AcACP = P.k8_8r.*c_C2_FabF_AcACP - P.k8_8f.*c_FabF.*c_AcACP + P.k10_8r.*c_C2_FabB_AcACP - P.k10_8f.*c_FabB.*c_AcACP; 

% FabB-Acetyl-ACP (e10T_2)
d_C2_FabB_AcACP = P.kcat10_CO2.*c_FabB_MalACP + P.k10_8f.*c_FabB.*c_AcACP - P.k10_8r.*c_C2_FabB_AcACP + P.k10_9r.*c_C2_FabB_Act.*c_ACP - P.k10_9f.*c_C2_FabB_AcACP; 

% FabF-Malonyl-ACP (e8p4)
d_FabF_MalACP = P.k8_7f.*c_FabF.*c_MalACP - P.k8_7r.*c_FabF_MalACP - P.kcat8_CO2.*c_FabF_MalACP; 

% FabF-Acetyl-ACP (e8T_2)
d_C2_FabF_AcACP = P.kcat8_CO2.*c_FabF_MalACP + P.k8_8f.*c_FabF.*c_AcACP - P.k8_8r.*c_C2_FabF_AcACP + P.k8_9r.*c_C2_FabF_Act.*c_ACP - P.k8_9f.*c_C2_FabF_AcACP; 


dcdt = [d_ATP; d_Bicarbonate; d_AcCoA; d_SucCoA; d_HexCoA; d_OcCoA; d_DecCoA; d_LauCoA; d_EthCoA; d_PalCoA; d_OcDecCoA; d_ACP; d_NADPH; d_NADP;  d_NADH; d_NAD; d_ADP; ...
    d_MalCoA; d_CoA; d_MalACP; d_CO2; d_C4_BKeACP; d_C6_BKeACP; d_C8_BKeACP; d_C10_BKeACP; d_C12_BKeACP; d_C14_BKeACP; d_C16_BKeACP; d_C18_BKeACP; ...
    ...
    d_C16_FA; d_C18_FA; d_C20_FA; d_C12_FA_un; d_C14_FA_un; d_C16_FA_un; d_C18_FA_un; d_C20_FA_un; d_ACC_s1; d_ACC_s2; d_ACC_s3; d_ACC_s4; d_FabD_MalCoA; ...
    d_FabD_Act; d_FabD_Act_ACP; d_C2_FabH_CoA; d_C4_FabH_CoA; d_C6_FabH_CoA; d_C8_FabH_CoA; d_C10_FabH_CoA; d_C12_FabH_CoA; d_C14_FabH_CoA; ...
    ...
    d_TesA_ACP; d_FabH_ACP; d_FabG_ACP; d_FabZ_ACP; d_FabI_ACP; d_FabF_ACP; d_FabA_ACP; d_FabB_ACP; d_FabB_AcCoA; d_C2_FabB_Act; d_C2_FabB_Act_MalACP; d_FabF_AcCoA; ...
    d_C2_FabF_Act; d_C2_FabF_Act_MalACP; d_FabB_MalACP; d_AcACP; d_C2_FabB_AcACP; d_FabF_MalACP; d_C2_FabF_AcACP];
