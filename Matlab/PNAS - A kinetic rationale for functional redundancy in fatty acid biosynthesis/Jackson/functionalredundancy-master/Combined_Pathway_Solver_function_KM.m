...
function [F_weighted,F_raw_all,unsat_out,T,C] = Combined_Pathway_Solver_function_KM(init_cond,enz_conc,time_range)
...
%10 and 11 of p_vec = TesA linear free energy slope and intercept (as a function of chain length)
...
field25 = 'TesA_fitting_source';val25 = 'Pf';%source of thioesterase fitting ('Pf'; Pfleger group measurements, 'Fox'; Fox group measurements', 'R3M4'; For TesA R3M4, 'Non-native'; For alternative thioesterases)
...
for i = 1:length(param_names{1})
    param_struct.(param_names{1}{i}) = param_func_KM(param_names{1}{i},i,opt_struct,tables);
end
