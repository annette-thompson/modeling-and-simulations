...
d_C2_AcCoA = P.k1_5r.*c_C3_CT_Act_AcCoA - P.k1_5f.*c_C1_CT_Act.*c_C2_AcCoA + P.k3_1r(1).*c_C2_KASIII_CoA - P.k3_1f(1).*c_KASIII.*c_C2_AcCoA + P.k8_4r.*c_C2_KASI_AcCoA - P.k8_4f.*c_KASI.*c_C2_AcCoA + P.k10_4r.*c_C2_KASII_AcCoA - P.k10_4f.*c_KASII.*c_C2_AcCoA;
...
d_ACP = P.k2_3r.*c_C3_MCMT_Act_ACP - P.k2_3f.*c_C3_MCMT_Act.*c_ACP...
    ...
    + P.k8_2f(5).*c_C12_KASI_AcACP_un  - P.k8_2r(5).*c_C12_KASI_Act_un.*c_ACP...
    + P.k8_2f(6).*c_C14_KASI_AcACP_un  - P.k8_2r(6).*c_C14_KASI_Act_un.*c_ACP...
    + P.k8_2f(7).*c_C16_KASI_AcACP_un  - P.k8_2r(7).*c_C16_KASI_Act_un.*c_ACP...
    + P.k8_2f(8).*c_C18_KASI_AcACP_un  - P.k8_2r(8).*c_C18_KASI_Act_un.*c_ACP...
    ...
    + P.k10_2f(5).*c_C12_KASII_AcACP_un - P.k10_2r(5).*c_C12_KASII_Act_un.*c_ACP...
    + P.k10_2f(6).*c_C14_KASII_AcACP_un - P.k10_2r(6).*c_C14_KASII_Act_un.*c_ACP...
    + P.k10_2f(7).*c_C16_KASII_AcACP_un - P.k10_2r(7).*c_C16_KASII_Act_un.*c_ACP...
    + P.k10_2f(8).*c_C18_KASII_AcACP_un - P.k10_2r(8).*c_C18_KASII_Act_un.*c_ACP...
    + P.k10_2f(4).*c_C10_KASII_cis3EnAcACP - P.k10_2r(4).*c_C10_KASII_Act_cis3.*c_ACP...
...
d_C3_MalACP = P.k2_4f.*c_C3_MCMT_Act_ACP - P.k2_4r.*c_MCMT.*c_C3_MalACP...
    ...
    + P.k8_3r(5).*c_C15_KASI_Act_MalACP_un - P.k8_3f(5).*c_C12_KASI_Act_un.*c_C3_MalACP...
    + P.k8_3r(6).*c_C17_KASI_Act_MalACP_un - P.k8_3f(6).*c_C14_KASI_Act_un.*c_C3_MalACP...
    + P.k8_3r(7).*c_C19_KASI_Act_MalACP_un - P.k8_3f(7).*c_C16_KASI_Act_un.*c_C3_MalACP...
    + P.k8_3r(8).*c_C21_KASI_Act_MalACP_un - P.k8_3f(8).*c_C18_KASI_Act_un.*c_C3_MalACP...
    ...
    + P.k10_3r(5).*c_C15_KASII_Act_MalACP_un - P.k10_3f(5).*c_C12_KASII_Act_un.*c_C3_MalACP...
    + P.k10_3r(6).*c_C17_KASII_Act_MalACP_un - P.k10_3f(6).*c_C14_KASII_Act_un.*c_C3_MalACP...
    + P.k10_3r(7).*c_C19_KASII_Act_MalACP_un - P.k10_3f(7).*c_C16_KASII_Act_un.*c_C3_MalACP...
    + P.k10_3r(8).*c_C21_KASII_Act_MalACP_un - P.k10_3f(8).*c_C18_KASII_Act_un.*c_C3_MalACP...
    + P.k10_3r(4).*c_C13_KASII_Act_cis3MalACP - P.k10_3f(4).*c_C10_KASII_Act_cis3.*c_C3_MalACP...
...
d_C1_CO2 = P.kcat3(1).*c_C5_KASIII_Act_MalACP + P.kcat3(2).*c_C7_KASIII_Act_MalACP + P.kcat3(3).*c_C9_KASIII_Act_MalACP + P.kcat3(4).*c_C11_KASIII_Act_MalACP...
    ...
    + P.kcat8_un(5).*c_C15_KASI_Act_MalACP_un + P.kcat8_un(6).*c_C17_KASI_Act_MalACP_un + P.kcat8_un(7).*c_C19_KASI_Act_MalACP_un + P.kcat8_un(8).*c_C21_KASI_Act_MalACP_un...
    ...
    + P.kcat10_un(4).*c_C13_KASII_Act_cis3MalACP + P.kcat10_un(5).*c_C15_KASII_Act_MalACP_un + P.kcat10_un(6).*c_C17_KASII_Act_MalACP_un + P.kcat10_un(7).*c_C19_KASII_Act_MalACP_un + P.kcat10_un(8).*c_C21_KASII_Act_MalACP_un...
...
d_C12_BKeACP_un =                                                                      P.kcat10_un(4).*c_C13_KASII_Act_cis3MalACP + P.k4_2r(5).*c_C12_KAR_NADPH_BKeACP_un - P.k4_2f(5).*c_KAR_NADPH.*c_C12_BKeACP_un;
d_C14_BKeACP_un = P.kcat8_un(5).*c_C15_KASI_Act_MalACP_un + P.kcat10_un(5).*c_C15_KASII_Act_MalACP_un + P.k4_2r(6).*c_C14_KAR_NADPH_BKeACP_un - P.k4_2f(6).*c_KAR_NADPH.*c_C14_BKeACP_un;
d_C16_BKeACP_un = P.kcat8_un(6).*c_C17_KASI_Act_MalACP_un + P.kcat10_un(6).*c_C17_KASII_Act_MalACP_un + P.k4_2r(7).*c_C16_KAR_NADPH_BKeACP_un - P.k4_2f(7).*c_KAR_NADPH.*c_C16_BKeACP_un;
...
d_KAR_NADPH = P.k4_1f(1).*c_KAR.*c_NADPH - P.k4_1r(1).*c_KAR_NADPH...
 ...
 + P.k4_2r(5).*c_C12_KAR_NADPH_BKeACP_un - P.k4_2f(5).*c_KAR_NADPH.*c_C12_BKeACP_un...
...
d_C12_KAR_NADPH_BKeACP_un = P.k4_2f(5).*c_KAR_NADPH.*c_C12_BKeACP_un - P.k4_2r(5).*c_C12_KAR_NADPH_BKeACP_un - P.kcat4(5).*c_C12_KAR_NADPH_BKeACP_un;
d_C14_KAR_NADPH_BKeACP_un = P.k4_2f(6).*c_KAR_NADPH.*c_C14_BKeACP_un - P.k4_2r(6).*c_C14_KAR_NADPH_BKeACP_un - P.kcat4(6).*c_C14_KAR_NADPH_BKeACP_un;
d_C16_KAR_NADPH_BKeACP_un = P.k4_2f(7).*c_KAR_NADPH.*c_C16_BKeACP_un - P.k4_2r(7).*c_C16_KAR_NADPH_BKeACP_un - P.kcat4(7).*c_C16_KAR_NADPH_BKeACP_un;
d_C18_KAR_NADPH_BKeACP_un = P.k4_2f(8).*c_KAR_NADPH.*c_C18_BKeACP_un - P.k4_2r(8).*c_C18_KAR_NADPH_BKeACP_un - P.kcat4(8).*c_C18_KAR_NADPH_BKeACP_un;
d_C20_KAR_NADPH_BKeACP_un = P.k4_2f(9).*c_KAR_NADPH.*c_C20_BKeACP_un - P.k4_2r(9).*c_C20_KAR_NADPH_BKeACP_un - P.kcat4(9).*c_C20_KAR_NADPH_BKeACP_un;
...
d_C12_HAD_BHyAcACP_un = P.k5_1f(5).*c_HAD.*c_C12_BHyAcACP_un - P.k5_1r(5).*c_C12_HAD_BHyAcACP_un + P.k5_2r(5).*c_C12_HAD_EnAcACP_un - P.kcat5(5).*c_C12_HAD_BHyAcACP_un;
d_C14_HAD_BHyAcACP_un = P.k5_1f(6).*c_HAD.*c_C14_BHyAcACP_un - P.k5_1r(6).*c_C14_HAD_BHyAcACP_un + P.k5_2r(6).*c_C14_HAD_EnAcACP_un - P.kcat5(6).*c_C14_HAD_BHyAcACP_un;
d_C16_HAD_BHyAcACP_un = P.k5_1f(7).*c_HAD.*c_C16_BHyAcACP_un - P.k5_1r(7).*c_C16_HAD_BHyAcACP_un + P.k5_2r(7).*c_C16_HAD_EnAcACP_un - P.kcat5(7).*c_C16_HAD_BHyAcACP_un;
d_C18_HAD_BHyAcACP_un = P.k5_1f(8).*c_HAD.*c_C18_BHyAcACP_un - P.k5_1r(8).*c_C18_HAD_BHyAcACP_un + P.k5_2r(8).*c_C18_HAD_EnAcACP_un - P.kcat5(8).*c_C18_HAD_BHyAcACP_un;
d_C20_HAD_BHyAcACP_un = P.k5_1f(9).*c_HAD.*c_C20_BHyAcACP_un - P.k5_1r(9).*c_C20_HAD_BHyAcACP_un + P.k5_2r(9).*c_C20_HAD_EnAcACP_un - P.kcat5(9).*c_C20_HAD_BHyAcACP_un;
...
d_C12_HAD_EnAcACP_un = P.kcat5(5).*c_C12_HAD_BHyAcACP_un - P.k5_2r(5).*c_C12_HAD_EnAcACP_un + P.k5_3r(5).*c_HAD.*c_C12_EnAcACP_un - P.k5_3f(5).*c_C12_HAD_EnAcACP_un;
d_C14_HAD_EnAcACP_un = P.kcat5(6).*c_C14_HAD_BHyAcACP_un - P.k5_2r(6).*c_C14_HAD_EnAcACP_un + P.k5_3r(6).*c_HAD.*c_C14_EnAcACP_un - P.k5_3f(6).*c_C14_HAD_EnAcACP_un;
d_C16_HAD_EnAcACP_un = P.kcat5(7).*c_C16_HAD_BHyAcACP_un - P.k5_2r(7).*c_C16_HAD_EnAcACP_un + P.k5_3r(7).*c_HAD.*c_C16_EnAcACP_un - P.k5_3f(7).*c_C16_HAD_EnAcACP_un;
...
d_ER_NADH = P.k6_1f(1).*c_ER.*c_NADH - P.k6_1r(1).*c_ER_NADH...
 ...
 + P.k6_2r(5).*c_C12_ER_NADH_EnAcACP_un - P.k6_2f(5).*c_ER_NADH.*c_C12_EnAcACP_un...
 + P.k6_2r(6).*c_C14_ER_NADH_EnAcACP_un - P.k6_2f(6).*c_ER_NADH.*c_C14_EnAcACP_un...
 + P.k6_2r(7).*c_C16_ER_NADH_EnAcACP_un - P.k6_2f(7).*c_ER_NADH.*c_C16_EnAcACP_un...
 + P.k6_2r(8).*c_C18_ER_NADH_EnAcACP_un - P.k6_2f(8).*c_ER_NADH.*c_C18_EnAcACP_un...
 + P.k6_2r(9).*c_C20_ER_NADH_EnAcACP_un - P.k6_2f(9).*c_ER_NADH.*c_C20_EnAcACP_un;
...
d_C12_ER_NADH_EnAcACP_un = P.k6_2f(5).*c_ER_NADH.*c_C12_EnAcACP_un - P.k6_2r(5).*c_C12_ER_NADH_EnAcACP_un - P.kcat6(5).*c_C12_ER_NADH_EnAcACP_un;
d_C14_ER_NADH_EnAcACP_un = P.k6_2f(6).*c_ER_NADH.*c_C14_EnAcACP_un - P.k6_2r(6).*c_C14_ER_NADH_EnAcACP_un - P.kcat6(6).*c_C14_ER_NADH_EnAcACP_un;
d_C16_ER_NADH_EnAcACP_un = P.k6_2f(7).*c_ER_NADH.*c_C16_EnAcACP_un - P.k6_2r(7).*c_C16_ER_NADH_EnAcACP_un - P.kcat6(7).*c_C16_ER_NADH_EnAcACP_un;
d_C18_ER_NADH_EnAcACP_un = P.k6_2f(8).*c_ER_NADH.*c_C18_EnAcACP_un - P.k6_2r(8).*c_C18_ER_NADH_EnAcACP_un - P.kcat6(8).*c_C18_ER_NADH_EnAcACP_un;
d_C20_ER_NADH_EnAcACP_un = P.k6_2f(9).*c_ER_NADH.*c_C20_EnAcACP_un - P.k6_2r(9).*c_C20_ER_NADH_EnAcACP_un - P.kcat6(9).*c_C20_ER_NADH_EnAcACP_un;
...
d_C12_KASI_AcACP_un = P.k8_1f(5).*c_KASI.*c_C12_AcACP_un - P.k8_1r(5).*c_C12_KASI_AcACP_un + P.k8_2r(5).*c_C12_KASI_Act_un.*c_ACP - P.k8_2f(5).*c_C12_KASI_AcACP_un;
d_C14_KASI_AcACP_un = P.k8_1f(6).*c_KASI.*c_C14_AcACP_un - P.k8_1r(6).*c_C14_KASI_AcACP_un + P.k8_2r(6).*c_C14_KASI_Act_un.*c_ACP - P.k8_2f(6).*c_C14_KASI_AcACP_un;
d_C16_KASI_AcACP_un = P.k8_1f(7).*c_KASI.*c_C16_AcACP_un - P.k8_1r(7).*c_C16_KASI_AcACP_un + P.k8_2r(7).*c_C16_KASI_Act_un.*c_ACP - P.k8_2f(7).*c_C16_KASI_AcACP_un;
d_C18_KASI_AcACP_un = P.k8_1f(8).*c_KASI.*c_C18_AcACP_un - P.k8_1r(8).*c_C18_KASI_AcACP_un + P.k8_2r(8).*c_C18_KASI_Act_un.*c_ACP - P.k8_2f(8).*c_C18_KASI_AcACP_un;
...
% C2n:1 (n=6:9) KASI*
d_C12_KASI_Act_un = P.k8_2f(5).*c_C12_KASI_AcACP_un - P.k8_2r(5).*c_C12_KASI_Act_un.*c_ACP + P.k8_3r(5).*c_C15_KASI_Act_MalACP_un - P.k8_3f(5).*c_C12_KASI_Act_un.*c_C3_MalACP;
d_C14_KASI_Act_un = P.k8_2f(6).*c_C14_KASI_AcACP_un - P.k8_2r(6).*c_C14_KASI_Act_un.*c_ACP + P.k8_3r(6).*c_C17_KASI_Act_MalACP_un - P.k8_3f(6).*c_C14_KASI_Act_un.*c_C3_MalACP;
d_C16_KASI_Act_un = P.k8_2f(7).*c_C16_KASI_AcACP_un - P.k8_2r(7).*c_C16_KASI_Act_un.*c_ACP + P.k8_3r(7).*c_C19_KASI_Act_MalACP_un - P.k8_3f(7).*c_C16_KASI_Act_un.*c_C3_MalACP;
d_C18_KASI_Act_un = P.k8_2f(8).*c_C18_KASI_AcACP_un - P.k8_2r(8).*c_C18_KASI_Act_un.*c_ACP + P.k8_3r(8).*c_C21_KASI_Act_MalACP_un - P.k8_3f(8).*c_C18_KASI_Act_un.*c_C3_MalACP;
...
d_C15_KASI_Act_MalACP_un = P.k8_3f(5).*c_C12_KASI_Act_un.*c_C3_MalACP - P.k8_3r(5).*c_C15_KASI_Act_MalACP_un - P.kcat8_un(5).*c_C15_KASI_Act_MalACP_un;
d_C17_KASI_Act_MalACP_un = P.k8_3f(6).*c_C14_KASI_Act_un.*c_C3_MalACP - P.k8_3r(6).*c_C17_KASI_Act_MalACP_un - P.kcat8_un(6).*c_C17_KASI_Act_MalACP_un;
d_C19_KASI_Act_MalACP_un = P.k8_3f(7).*c_C16_KASI_Act_un.*c_C3_MalACP - P.k8_3r(7).*c_C19_KASI_Act_MalACP_un - P.kcat8_un(7).*c_C19_KASI_Act_MalACP_un;
d_C21_KASI_Act_MalACP_un = P.k8_3f(8).*c_C18_KASI_Act_un.*c_C3_MalACP - P.k8_3r(8).*c_C21_KASI_Act_MalACP_un - P.kcat8_un(8).*c_C21_KASI_Act_MalACP_un;
...
d_C12_KASII_AcACP_un = P.k10_1f(5).*c_KASII.*c_C12_AcACP_un - P.k10_1r(5).*c_C12_KASII_AcACP_un + P.k10_2r(5).*c_C12_KASII_Act_un.*c_ACP - P.k10_2f(5).*c_C12_KASII_AcACP_un;
d_C14_KASII_AcACP_un = P.k10_1f(6).*c_KASII.*c_C14_AcACP_un - P.k10_1r(6).*c_C14_KASII_AcACP_un + P.k10_2r(6).*c_C14_KASII_Act_un.*c_ACP - P.k10_2f(6).*c_C14_KASII_AcACP_un;
d_C16_KASII_AcACP_un = P.k10_1f(7).*c_KASII.*c_C16_AcACP_un - P.k10_1r(7).*c_C16_KASII_AcACP_un + P.k10_2r(7).*c_C16_KASII_Act_un.*c_ACP - P.k10_2f(7).*c_C16_KASII_AcACP_un;
d_C18_KASII_AcACP_un = P.k10_1f(8).*c_KASII.*c_C18_AcACP_un - P.k10_1r(8).*c_C18_KASII_AcACP_un + P.k10_2r(8).*c_C18_KASII_Act_un.*c_ACP - P.k10_2f(8).*c_C18_KASII_AcACP_un;
...
% C2n:1 (n=6:9) KASII*
d_C12_KASII_Act_un = P.k10_2f(5).*c_C12_KASII_AcACP_un - P.k10_2r(5).*c_C12_KASII_Act_un.*c_ACP + P.k10_3r(5).*c_C15_KASII_Act_MalACP_un - P.k10_3f(5).*c_C12_KASII_Act_un.*c_C3_MalACP;
d_C14_KASII_Act_un = P.k10_2f(6).*c_C14_KASII_AcACP_un - P.k10_2r(6).*c_C14_KASII_Act_un.*c_ACP + P.k10_3r(6).*c_C17_KASII_Act_MalACP_un - P.k10_3f(6).*c_C14_KASII_Act_un.*c_C3_MalACP;
d_C16_KASII_Act_un = P.k10_2f(7).*c_C16_KASII_AcACP_un - P.k10_2r(7).*c_C16_KASII_Act_un.*c_ACP + P.k10_3r(7).*c_C19_KASII_Act_MalACP_un - P.k10_3f(7).*c_C16_KASII_Act_un.*c_C3_MalACP;
d_C18_KASII_Act_un = P.k10_2f(8).*c_C18_KASII_AcACP_un - P.k10_2r(8).*c_C18_KASII_Act_un.*c_ACP + P.k10_3r(8).*c_C21_KASII_Act_MalACP_un - P.k10_3f(8).*c_C18_KASII_Act_un.*c_C3_MalACP;
...
d_C15_KASII_Act_MalACP_un = P.k10_3f(5).*c_C12_KASII_Act_un.*c_C3_MalACP - P.k10_3r(5).*c_C15_KASII_Act_MalACP_un - P.kcat10_un(5).*c_C15_KASII_Act_MalACP_un;
d_C17_KASII_Act_MalACP_un = P.k10_3f(6).*c_C14_KASII_Act_un.*c_C3_MalACP - P.k10_3r(6).*c_C17_KASII_Act_MalACP_un - P.kcat10_un(6).*c_C17_KASII_Act_MalACP_un;
d_C19_KASII_Act_MalACP_un = P.k10_3f(7).*c_C16_KASII_Act_un.*c_C3_MalACP - P.k10_3r(7).*c_C19_KASII_Act_MalACP_un - P.kcat10_un(7).*c_C19_KASII_Act_MalACP_un;
d_C21_KASII_Act_MalACP_un = P.k10_3f(8).*c_C18_KASII_Act_un.*c_C3_MalACP - P.k10_3r(8).*c_C21_KASII_Act_MalACP_un - P.kcat10_un(8).*c_C21_KASII_Act_MalACP_un;

% KASII-(C10 cis-3-Enoyl-Acyl-ACP)
d_C10_KASII_cis3EnAcACP = P.k10_1f(4).*c_KASII.*c_C10_cis3EnAcACP - P.k10_1r(4).*c_C10_KASII_cis3EnAcACP + P.k10_2r(4).*c_C10_KASII_Act_cis3.*c_ACP - P.k10_2f(4).*c_C10_KASII_cis3EnAcACP;

% C10 cis-3-KASII*
d_C10_KASII_Act_cis3 = P.k10_2f(4).*c_C10_KASII_cis3EnAcACP - P.k10_2r(4).*c_C10_KASII_Act_cis3.*c_ACP + P.k10_3r(4).*c_C13_KASII_Act_cis3MalACP - P.k10_3f(4).*c_C10_KASII_Act_cis3.*c_C3_MalACP;

% C10 cis-3-KASII*-Malonyl-ACP
d_C13_KASII_Act_cis3MalACP = P.k10_3f(4).*c_C10_KASII_Act_cis3.*c_C3_MalACP - P.k10_3r(4).*c_C13_KASII_Act_cis3MalACP - P.kcat10_un(4).*c_C13_KASII_Act_cis3MalACP;
