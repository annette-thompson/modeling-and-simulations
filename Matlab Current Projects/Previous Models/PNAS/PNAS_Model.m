function [Total_Production, Product_Profile] = PNAS_Model(time_range,init_cond,enzyme_conc)
% Modified from Combined_Pathway_Solver_script.m
...
field17 = 'enzyme_conc'; val17 = enzyme_conc;%Initial enzyme conentrations (ACC,FabD,FabH,FabG,FabZ,FabI,TesA,FabF,FabA,FabB)
...
[T,C] = ode15s(parameterized_Combined_Pathway_Model,time_range,init_cond,options);
