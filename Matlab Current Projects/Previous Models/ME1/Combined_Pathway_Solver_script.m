...
field17 = 'enzyme_conc'; val17 = [0 1 0 1 1 1 10 1 1 1];%Initial enzyme conentrations (ACC,FabD,FabH,FabG,FabZ,FabI,TesA,FabF,FabA,FabB)
...
rel_rate_EC_FabH = F_weighted(end,1)/2.5
