...
mu=[0 0 10 1000 1000 500  1    0    1    1    1    10   1    1    1];
sigma = 0.05.*mu;
...
writetable(output_data, 'Model_error_output_No_FabH_No_Acyl_CoA.csv');
writetable(summary_data, 'Model_error_summary_No_FabH_No_Acyl_CoA.csv');