%FAS solver Function
%Solves the system of ordindary differential equations consisting of the kinetic equations of the FAME pathway 
%   Input:
...
function [FAME] = CPS_FAME_solv(init_cond,enz_conc,time_range,p_vec_k)
...
field25 = 'TesA_fitting_source';val25 = 'BTE';%source of thioesterase fitting ('Pf'; Pfleger group measurements, 'Fox'; Fox group measurements', 'Non-native'; For alternative thioesterases)
...
parameterized_Combined_Pathway_Model = @(t,c) Combined_Pathway_Model_FAME(t,c,param_struct,opt_struct,p_vec_k);
