...
function [ket_amt,FA_ratio] = CPS_Ket_solv(init_cond,enz_conc,time_range,struct_k,p_vec_k)
...
opt_struct = struct(field5,val5,field6,val6,field10,val10,field11,val11,field12,val12,field13,val13,field14,val14,field15,val15,...
    ...
    field26,val26,field27,val27,field28,val28,field29,val29,field30,val30,field31,val31);
...
parameterized_Combined_Pathway_Model = @(t,c) Combined_Pathway_Model_Ket(t,c,param_struct,opt_struct);
