%FAS solver Function
%Solves the system of ordindary differential equations consisting of the kinetic equations of the MK pathway 
%   Input:
...
function [ket_amt,FA_ratio] = CPS_Thiol_solv(init_cond,enz_conc,time_range,struct_k,p_vec_k,p_vec_new)
...
field25 = 'TesA_fitting_source';val25 = struct_k.ket_cond.TE_ident(struct_k.count);%source of thioesterase fitting ('Pf'; Pfleger group measurements, 'Fox'; Fox group measurements', 'Non-native'; For alternative thioesterases)
...
field30 = 'Ketone_params';val30 = struct_k;
field31 = 'Ketone_vars';val31 = p_vec_k;
field32 = 'opt_vec'; val32 = p_vec_new;
...
opt_struct = struct(field5,val5,field6,val6,field10,val10,field11,val11,field12,val12,field13,val13,field14,val14,field15,val15,...
    ...
    field26,val26,field27,val27,field28,val28,field29,val29,field30,val30,field31,val31,field32,val32);
...
parameterized_Combined_Pathway_Model = @(t,c) Combined_Pathway_Model_Thiol(t,c,param_struct,opt_struct);
...
ket_amt = C(end,394:406);
FA_ratio = [C(end,37)/C(end,397) C(end,47)/C(end,398) C(end,52)/C(end,402) C(end,57)/C(end,399) C(end,62)/C(end,403)];