...
function [FA_alc] = CPS_Alc_solv(init_cond,enz_conc,time_range,p_vec_k)
...
field25 = 'TesA_fitting_source';val25 = 'TesA';%source of thioesterase fitting ('Pf'; Pfleger group measurements, 'Fox'; Fox group measurements', 'Non-native'; For alternative thioesterases)
