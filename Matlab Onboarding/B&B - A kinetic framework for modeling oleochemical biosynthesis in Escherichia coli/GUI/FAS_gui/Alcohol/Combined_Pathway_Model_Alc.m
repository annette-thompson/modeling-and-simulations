function dy = Combined_Pathway_Model_Alc(t,y,param_list,opt_struct)
...
%CAR, doi.org/10.1073/pnas.1216516110
kcatC = [2.539177104 2.073274834 1.403966193 0.907278036 0.550853494 0.135380245 0.069782241 0.004887844 0.550853494 0.135380245 0.069782241 0.446286743];
Km_ATP = 115;
Km_FA = [12894.46706 598.5081432 143.586142 51.93964039 13.47446955 13.47446955 13.47446955 13.47446955 13.47446955 13.47446955	13.47446955	13.47446955];
Km_CAR_NADPH = 48;

%Ahr, DOI 10.1007/s00253-012-4474-5
kcatAhr = [464.4 516.5948127 246.2524496 5.353314121 8.029971182 8.029971182 8.029971182 8.029971182 8.029971182 8.029971182 8.029971182 8.029971182];
Km_Ahr_NADPH = 60;
Km_FA_Ald = [2100 340 340 340 340 340 340 340 340 340 340 340];

%Enzyme concentrations (uM)
CAR = opt_struct.aux_enz(1);
Ahr = opt_struct.aux_enz(2);
...
dy = zeros(360,size(y,2));

%set of differential equations
dy(1,:) = k1_1r.*y(83,:) - k1_1f.*e1.*y(1,:)...
    - kcatC(1).*CAR.*y(1,:).*y(16,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(1)+y(16,:)).*(Km_CAR_NADPH+y(6,:)))...
    - kcatC(2).*CAR.*y(1,:).*y(21,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(2)+y(21,:)).*(Km_CAR_NADPH+y(6,:)))...
    - kcatC(3).*CAR.*y(1,:).*y(26,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(3)+y(26,:)).*(Km_CAR_NADPH+y(6,:)))...
    - kcatC(4).*CAR.*y(1,:).*y(31,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(4)+y(31,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(5).*CAR.*y(1,:).*y(37,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(5)+y(37,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(6).*CAR.*y(1,:).*y(47,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(6)+y(47,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(7).*CAR.*y(1,:).*y(57,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(7)+y(57,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(8).*CAR.*y(1,:).*y(67,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(8)+y(67,:)).*(Km_CAR_NADPH+y(6,:)))...
    - kcatC(9).*CAR.*y(1,:).*y(42,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(9)+y(42,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(10).*CAR.*y(1,:).*y(52,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(10)+y(52,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(11).*CAR.*y(1,:).*y(62,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(11)+y(62,:)).*(Km_CAR_NADPH+y(6,:)))...
	- kcatC(12).*CAR.*y(1,:).*y(72,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(12)+y(72,:)).*(Km_CAR_NADPH+y(6,:)));
...
dy(6,:) = k6_1r(1).*y(94,:) - k6_1f(1).*e6.*y(6,:)...
    - kcatC(1).*CAR.*y(1,:).*y(16,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(1)+y(16,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(1).*Ahr.*y(6,:).*y(337,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(1)+y(337,:)))...%4
    - kcatC(2).*CAR.*y(1,:).*y(21,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(2)+y(21,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(2).*Ahr.*y(6,:).*y(338,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(2)+y(338,:)))...%6
    - kcatC(3).*CAR.*y(1,:).*y(26,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(3)+y(26,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(3).*Ahr.*y(6,:).*y(339,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(3)+y(339,:)))...%8
    - kcatC(4).*CAR.*y(1,:).*y(31,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(4)+y(31,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(4).*Ahr.*y(6,:).*y(340,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(4)+y(340,:)))...%10
    - kcatC(5).*CAR.*y(1,:).*y(37,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(5)+y(37,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(5).*Ahr.*y(6,:).*y(341,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(5)+y(341,:)))...%12
    - kcatC(6).*CAR.*y(1,:).*y(47,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(6)+y(47,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(6).*Ahr.*y(6,:).*y(342,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(6)+y(342,:)))...%14
    - kcatC(7).*CAR.*y(1,:).*y(57,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(7)+y(57,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(7).*Ahr.*y(6,:).*y(343,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(7)+y(343,:)))...%16
    - kcatC(8).*CAR.*y(1,:).*y(67,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(8)+y(67,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(8).*Ahr.*y(6,:).*y(344,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(8)+y(344,:)))...%18
    - kcatC(9).*CAR.*y(1,:).*y(42,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(9)+y(42,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(9).*Ahr.*y(6,:).*y(345,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(9)+y(345,:)))...%12_unsat
    - kcatC(10).*CAR.*y(1,:).*y(52,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(10)+y(52,:)).*(Km_CAR_NADPH+y(6,:))) -kcatAhr(10).*Ahr.*y(6,:).*y(346,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(10)+y(346,:)))...%14_unsat
    - kcatC(11).*CAR.*y(1,:).*y(62,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(11)+y(62,:)).*(Km_CAR_NADPH+y(6,:))) -kcatAhr(11).*Ahr.*y(6,:).*y(347,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(11)+y(347,:)))...%16_unsat
    - kcatC(12).*CAR.*y(1,:).*y(72,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(12)+y(72,:)).*(Km_CAR_NADPH+y(6,:))) -kcatAhr(12).*Ahr.*y(6,:).*y(348,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(12)+y(348,:)));%18_unsat
...
% WHY DID I MAKE THESE SHORT?
dy(16,:) = kcat7(1).*y(101,:) - kcatC(1).*CAR.*y(1,:).*y(16,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(1)+y(16,:)).*(Km_CAR_NADPH+y(6,:)));
dy(21,:) = kcat7(2).*y(116,:) - kcatC(2).*CAR.*y(1,:).*y(21,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(2)+y(21,:)).*(Km_CAR_NADPH+y(6,:)));
dy(26,:) = kcat7(3).*y(131,:) - kcatC(3).*CAR.*y(1,:).*y(26,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(3)+y(26,:)).*(Km_CAR_NADPH+y(6,:)));
dy(31,:) = kcat7(4).*y(146,:) - kcatC(4).*CAR.*y(1,:).*y(31,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(4)+y(31,:)).*(Km_CAR_NADPH+y(6,:)));
dy(37,:) = kcat7(5).*y(161,:) - kcatC(5).*CAR.*y(1,:).*y(37,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(5)+y(37,:)).*(Km_CAR_NADPH+y(6,:)));
dy(47,:) = kcat7(6).*y(176,:) - kcatC(6).*CAR.*y(1,:).*y(47,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(6)+y(47,:)).*(Km_CAR_NADPH+y(6,:)));
dy(57,:) = kcat7(7).*y(191,:) - kcatC(7).*CAR.*y(1,:).*y(57,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(7)+y(57,:)).*(Km_CAR_NADPH+y(6,:)));
dy(67,:) = kcat7(8).*y(206,:) - kcatC(8).*CAR.*y(1,:).*y(67,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(8)+y(67,:)).*(Km_CAR_NADPH+y(6,:)));
dy(77,:) = kcat7(9).*y(221,:);

dy(42,:) = kcat7(5).*y(230,:) - kcatC(9).*CAR.*y(1,:).*y(42,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(9)+y(42,:)).*(Km_CAR_NADPH+y(6,:)));
dy(52,:) = kcat7(6).*y(245,:) - kcatC(10).*CAR.*y(1,:).*y(52,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(10)+y(52,:)).*(Km_CAR_NADPH+y(6,:)));
dy(62,:) = kcat7(7).*y(260,:) - kcatC(11).*CAR.*y(1,:).*y(62,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(11)+y(62,:)).*(Km_CAR_NADPH+y(6,:)));
dy(72,:) = kcat7(8).*y(275,:) - kcatC(12).*CAR.*y(1,:).*y(72,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(12)+y(72,:)).*(Km_CAR_NADPH+y(6,:)));
dy(82,:) = kcat7(9).*y(290,:);
...
dy(337,:) = kcatC(1).*CAR.*y(1,:).*y(16,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(1)+y(16,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(1).*Ahr.*y(6,:).*y(337,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(1)+y(337,:)));%4
dy(338,:) = kcatC(2).*CAR.*y(1,:).*y(21,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(2)+y(21,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(2).*Ahr.*y(6,:).*y(338,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(2)+y(338,:)));%6
dy(339,:) = kcatC(3).*CAR.*y(1,:).*y(26,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(3)+y(26,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(3).*Ahr.*y(6,:).*y(339,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(3)+y(339,:)));%8
dy(340,:) = kcatC(4).*CAR.*y(1,:).*y(31,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(4)+y(31,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(4).*Ahr.*y(6,:).*y(340,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(4)+y(340,:)));%10
dy(341,:) = kcatC(5).*CAR.*y(1,:).*y(37,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(5)+y(37,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(5).*Ahr.*y(6,:).*y(341,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(5)+y(341,:)));%12
dy(342,:) = kcatC(6).*CAR.*y(1,:).*y(47,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(6)+y(47,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(6).*Ahr.*y(6,:).*y(342,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(6)+y(342,:)));%14
dy(343,:) = kcatC(7).*CAR.*y(1,:).*y(57,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(7)+y(57,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(7).*Ahr.*y(6,:).*y(343,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(7)+y(343,:)));%16
dy(344,:) = kcatC(8).*CAR.*y(1,:).*y(67,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(8)+y(67,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(8).*Ahr.*y(6,:).*y(344,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(8)+y(344,:)));%18
dy(345,:) = kcatC(9).*CAR.*y(1,:).*y(42,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(9)+y(42,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(9).*Ahr.*y(6,:).*y(345,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(9)+y(345,:)));%12_unsat
dy(346,:) = kcatC(10).*CAR.*y(1,:).*y(52,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(10)+y(52,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(10).*Ahr.*y(6,:).*y(346,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(10)+y(346,:)));%14_unsat
dy(347,:) = kcatC(11).*CAR.*y(1,:).*y(62,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(11)+y(62,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(11).*Ahr.*y(6,:).*y(347,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(11)+y(347,:)));%16_unsat
dy(348,:) = kcatC(12).*CAR.*y(1,:).*y(72,:).*y(6,:)./((Km_ATP+y(1,:)).*(Km_FA(12)+y(72,:)).*(Km_CAR_NADPH+y(6,:))) - kcatAhr(12).*Ahr.*y(6,:).*y(348,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(12)+y(348,:)));%18_unsat

%Prodctuion of fatty-alcohols
dy(349,:) = kcatAhr(1).*Ahr.*y(6,:).*y(337,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(1)+y(337,:)));%4
dy(350,:) = kcatAhr(2).*Ahr.*y(6,:).*y(338,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(2)+y(338,:)));%6
dy(351,:) = kcatAhr(3).*Ahr.*y(6,:).*y(339,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(3)+y(339,:)));%8
dy(352,:) = kcatAhr(4).*Ahr.*y(6,:).*y(340,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(4)+y(340,:)));%10
dy(353,:) = kcatAhr(5).*Ahr.*y(6,:).*y(341,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(5)+y(341,:)));%12
dy(354,:) = kcatAhr(6).*Ahr.*y(6,:).*y(342,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(6)+y(342,:)));%14
dy(355,:) = kcatAhr(7).*Ahr.*y(6,:).*y(343,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(7)+y(343,:)));%16
dy(356,:) = kcatAhr(8).*Ahr.*y(6,:).*y(344,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(8)+y(344,:)));%18
dy(357,:) = kcatAhr(9).*Ahr.*y(6,:).*y(345,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(9)+y(345,:)));%12_unsat
dy(358,:) = kcatAhr(10).*Ahr.*y(6,:).*y(346,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(10)+y(346,:)));%14_unsat
dy(359,:) = kcatAhr(11).*Ahr.*y(6,:).*y(347,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(11)+y(347,:)));%16_unsat
dy(360,:) = kcatAhr(12).*Ahr.*y(6,:).*y(348,:)./((Km_Ahr_NADPH+y(6,:)).*(Km_FA_Ald(12)+y(348,:)));%18_unsat
