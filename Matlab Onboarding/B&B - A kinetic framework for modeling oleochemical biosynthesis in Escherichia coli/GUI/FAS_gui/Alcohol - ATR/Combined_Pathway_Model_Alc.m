...
%MB_ACR
kcatATR = 0.047.*[1*p_vec_k(1)  1*p_vec_k(1)  1*p_vec_k(1)  1*p_vec_k(1)  1*p_vec_k(2) 1*p_vec_k(3)  1*p_vec_k(1)  1*p_vec_k(2)  1*p_vec_k(3)]; %doi.org/10.1038/s41467-021-25831-w
Kd_ATR = 21; %doi.org/10.1038/s41467-021-25831-w
Kd_ATR_NADPH = 21; %doi.org/10.1038/s41467-021-25831-w

%Enzyme concentrations (uM)
ATR = opt_struct.aux_enz(1);
...
dy(4,:) = k2_3r.*y(89,:) - k2_3f.*y(88,:).*y(4,:)...
    ...
    + kcatATR(1).*ATR.*y(20,:).*y(6,:)./((Kd_ATR+y(20,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(2).*ATR.*y(25,:).*y(6,:)./((Kd_ATR+y(25,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(3).*ATR.*y(30,:).*y(6,:)./((Kd_ATR+y(30,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(4).*ATR.*y(36,:).*y(6,:)./((Kd_ATR+y(36,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(5).*ATR.*y(46,:).*y(6,:)./((Kd_ATR+y(46,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(6).*ATR.*y(56,:).*y(6,:)./((Kd_ATR+y(56,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(7).*ATR.*y(41,:).*y(6,:)./((Kd_ATR+y(41,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(8).*ATR.*y(51,:).*y(6,:)./((Kd_ATR+y(51,:)).*(Kd_ATR_NADPH+y(6,:)))...
    + kcatATR(9).*ATR.*y(61,:).*y(6,:)./((Kd_ATR+y(61,:)).*(Kd_ATR_NADPH+y(6,:)));
...
dy(36,:) =  kcat6(5).*y(160,:)+ k7_1r(5).*y(161,:)+ k8_1r(5).*y(162,:)+ k10_1r(5).*y(167,:) - k7_1f(5).*e7.*y(36,:)- k8_1f(5).*e8.*y(36,:)- k10_1f(5).*e10.*y(36,:)- k3_4f(5).*e3.*y(36,:)+ k3_4r(5).*y(155,:)- k3_5f(5).*y(91,:).*y(36,:)+ k3_5r(5).*y(156,:)...
            -A_kcat7.*LpxL.*y(320,:).*y(36,:)./((Km3+y(320,:).*(km_laur+y(36,:))))  -  kcatATR(4).*ATR.*y(36,:).*y(6,:)./((Kd_ATR+y(36,:)).*(Kd_ATR_NADPH+y(6,:)));
dy(46,:) =  kcat6(6).*y(175,:)+ k7_1r(6).*y(176,:)+ k8_1r(6).*y(177,:)+ k10_1r(6).*y(182,:) - k7_1f(6).*e7.*y(46,:)- k8_1f(6).*e8.*y(46,:)- k10_1f(6).*e10.*y(46,:)- k3_4f(6).*e3.*y(46,:)+ k3_4r(6).*y(170,:)- k3_5f(6).*y(91,:).*y(46,:)+ k3_5r(6).*y(171,:)...
            -A_kcat8.*LpxM.*y(317,:).*y(46,:)./((Km4+y(317,:).*(km_myr+y(46,:))))  -  kcatATR(5).*ATR.*y(46,:).*y(6,:)./((Kd_ATR+y(46,:)).*(Kd_ATR_NADPH+y(6,:)));
dy(56,:) =  kcat6(7).*y(190,:)+ k7_1r(7).*y(191,:)+ k8_1r(7).*y(192,:)+ k10_1r(7).*y(197,:) - k7_1f(7).*e7.*y(56,:)- k8_1f(7).*e8.*y(56,:)- k10_1f(7).*e10.*y(56,:)- k3_4f(7).*e3.*y(56,:)+ k3_4r(7).*y(185,:)- k3_5f(7).*y(91,:).*y(56,:)+ k3_5r(7).*y(186,:)...
            -kcatP1.*PlsB.*G3P.*y(56,:)./((KmP1+G3P).*(KmP2+y(56,:)))  -  kcatATR(6).*ATR.*y(56,:).*y(6,:)./((Kd_ATR+y(56,:)).*(Kd_ATR_NADPH+y(6,:)));
...
dy(61,:) =  kcat6(7).*y(259,:)+ k7_1r(7).*y(260,:)+ k8_1r(7).*y(261,:)+ k10_1r(7).*y(266,:) - k7_1f(7).*e7.*y(61,:)- k8_1f(7).*e8.*y(61,:)- k10_1f(7).*e10.*y(61,:)- k3_4f(7).*e3.*y(61,:)+ k3_4r(7).*y(254,:)- k3_5f(7).*y(91,:).*y(61,:)+ k3_5r(7).*y(255,:)...
            -kcatP2*PlsC.*y(324,:).*y(61,:)./((KmP4 + y(324,:)).*(KmP5 + y(61,:)))  -  kcatATR(9).*ATR.*y(61,:).*y(6,:)./((Kd_ATR+y(61,:)).*(Kd_ATR_NADPH+y(6,:)));
...
dy(337,:) = kcatATR(1).*ATR.*y(20,:).*y(6,:)./((Kd_ATR+y(20,:)).*(Kd_ATR_NADPH+y(6,:)));%6
dy(338,:) = kcatATR(2).*ATR.*y(25,:).*y(6,:)./((Kd_ATR+y(25,:)).*(Kd_ATR_NADPH+y(6,:)));%8
dy(339,:) = kcatATR(3).*ATR.*y(30,:).*y(6,:)./((Kd_ATR+y(30,:)).*(Kd_ATR_NADPH+y(6,:)));%10
dy(340,:) = kcatATR(4).*ATR.*y(36,:).*y(6,:)./((Kd_ATR+y(36,:)).*(Kd_ATR_NADPH+y(6,:)));%12
dy(341,:) = kcatATR(5).*ATR.*y(46,:).*y(6,:)./((Kd_ATR+y(46,:)).*(Kd_ATR_NADPH+y(6,:)));%14
dy(342,:) = kcatATR(6).*ATR.*y(56,:).*y(6,:)./((Kd_ATR+y(56,:)).*(Kd_ATR_NADPH+y(6,:)));%16
dy(343,:) = kcatATR(7).*ATR.*y(41,:).*y(6,:)./((Kd_ATR+y(41,:)).*(Kd_ATR_NADPH+y(6,:)));%12_unsat
dy(344,:) = kcatATR(8).*ATR.*y(51,:).*y(6,:)./((Kd_ATR+y(51,:)).*(Kd_ATR_NADPH+y(6,:)));%14_unsat
dy(345,:) = kcatATR(9).*ATR.*y(61,:).*y(6,:)./((Kd_ATR+y(61,:)).*(Kd_ATR_NADPH+y(6,:)));%16_unsat
