...
enz_identity = opt_struct.Ketone_params;
%Beta-oxidation and Ketone constants
%Beta-oxidation and Ketone constants
if strcmp(enz_identity(1),'ecFadD')
...
elseif strcmp(enz_identity(1),'FadD6')
    Km_ATP = 36; %doi.org/10.1016/0167-4838(85)90269-9
    Km_FA_AMP = [11.2  40.8  4.3 1.6  2.4  2.4  8.9  1.6  2.4  2.4  8.5]; %doi.org/10.1016/S0021-9258(19)69262-8
    Km_FA = [11.2  40.8  4.3 1.6  2.4  2.4  8.9  1.6  2.4  2.4  8.5]; %doi.org/10.1016/S0021-9258(19)69262-8
...
%FadE
% if strcmp(enz_identity(2),'ecFadE')
...
% elseif strcmp(enz_identity(2),'ACO')
%     Km_FAD = 1.9; %doi.org/10.1016/S0021-9258(18)33160-0
%     Km_FA_CoA = 0.947;%doi.org/10.1016/S0021-9258(18)33160-0
...
% if strcmp(enz_identity(3),'ecFadB')
    Km_FA_enoyl_CoA = 53;
    kcatB1 = 775;
    Km_NAD = 2;
    Km_hyd_acyl_CoA = 69; 
    kcatB2 = 382;
% elseif strcmp(enz_identity(3),'PpFadB')
%     Km_FA_enoyl_CoA = 53;
%     kcatB1 = 2*775;
%     Km_NAD = 2; 
%     Km_hyd_acyl_CoA = 69; 
...
%FadM 
%10.1021/bi800595f
if strcmp(enz_identity(3),'ecFadM')
    kcatM = opt_struct.Ketone_vars(4).*[0 1.6 1.6 1.6 6.2 10.2 0 21.6 23.7 10.2 0];
    Km_FadM_keto_acyl_CoA = [13.0  13.0 13.0 13.0 6.3 6.0 440 10.8 3.0 6.0 440];
    kcatM_ACP = 0.*kcatM;
elseif strcmp(enz_identity(3),'PsFadM')
...
if strcmp(enz_identity(2),'ecFadA')
    kcatfadA = opt_struct.opt_vec.*104;
elseif strcmp(enz_identity(2),'ReBktB')
...
FAD = opt_struct.aux_enz(1);
NAD = opt_struct.aux_enz(2);

FadD = opt_struct.aux_enz(3);
FadE = 0;
FadB = 0;
FadM =  opt_struct.aux_enz(5);
FadA =  opt_struct.aux_enz(4);


%TesA activity on acyl-CoAs
CoA_ACP_Km_Kd_ratio = 1.*(1/54);%Estimated ratio of KcatCoA/KcatACP for C14
if strcmp(opt_struct.TesA_fitting_source,'TesA')
...
elseif strcmp(opt_struct.TesA_fitting_source,'BTE')
    ...
    kd_est = param_list.k7_1r./(param_list.k7_1f);
    Km_TesA_FA_CoA = CoA_ACP_Km_Kd_ratio*[kd_est(2:8) kd_est(5) kd_est(6) kd_est(7) kd_est(8)];
elseif strcmp(opt_struct.TesA_fitting_source,'chFatB2')
    kcatTesA_CoA = [param_list.kcat7(2:8) param_list.kcat7(5) param_list.kcat7(6) param_list.kcat7(7) param_list.kcat7(8)];
    kd_est = param_list.k7_1r./(param_list.k7_1f);
    Km_TesA_FA_CoA = CoA_ACP_Km_Kd_ratio*[kd_est(2:8) kd_est(5) kd_est(6) kd_est(7) kd_est(8)];
elseif strcmp(opt_struct.TesA_fitting_source,'atFatA3')
    kcatTesA_CoA = [param_list.kcat7(2:8) param_list.kcat7(5) param_list.kcat7(6) param_list.kcat7(7) param_list.kcat7(8)];
    kd_est = param_list.k7_1r./(param_list.k7_1f);
    Km_TesA_FA_CoA = CoA_ACP_Km_Kd_ratio*[kd_est(2:8) kd_est(5) kd_est(6) kd_est(7) kd_est(8)];
end
