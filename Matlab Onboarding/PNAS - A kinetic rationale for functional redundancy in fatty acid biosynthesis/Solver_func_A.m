function [avg_chain]=Solver_func_A(X)
%FAS solver script
...
%chain, this modified form of the enzyme is denoted as enzyme name
...
field17 = 'enzyme_conc'; val17 = [0,X];%Initial enzyme conentrations (ACC,FabD,FabH,FabG,FabZ,FabI,TesA,FabF,FabA,FabB)
...
%generates the parameter values in parameter structure from the parameter
...
%point in T (rows)
[~,C] = ode15s(parameterized_Combined_Pathway_Model,range,init_cond,options);
...
%Calculate average chain length (uM concentration basis)
