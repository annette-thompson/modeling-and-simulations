...
function [total_FA,F_weighted,frac_FA,dist_FA,T,C] = CPS_Base_opt_solv(p_vec,init_cond,enz_conc,time_range)
...
'T_2';'e8p4';'e8T_2';'e8act2';'e8act2p4';'e10p4';'e10T_2';'e10act2';'e10s3';'e10act2p4';...
};
...
% field30 = 'rel_ZA'; val30 = p_vec(19); %scaling fabZ unsaturation activity
% field31 = 'rel_FB'; val31 = p_vec(20); %scaling fabF unsaturation activity. 
