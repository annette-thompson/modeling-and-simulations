...
function [total_FA,F_weighted,frac_FA] = CPS_Base_solv(init_cond,enz_conc,time_range)

%vector of model parameter values (fit values)
%p_vec = [a1 a2 a3 b1 c2 c1 c3 b2 b3 d1 d2 e f c4 g1 g2 h1 h2];
...
%p_vec = [106494.8474 7726.392489 4.617637215 62895.56962 87.77959928 0.005962119 4.288620753 0.005308707 0.295368266 -0.296472666 3.658257772 9.912128884 10.47061565 2164.845252];
%p_vec = [106494.8474 7726.392489 4.617637215 62895.56962 87.77959928 0.005962119 4.288620753 0.005308707 0.295368266 -0.296472666 3.658257772 9.912128884 132.8499358 2164.845252 0.539756276	0.053673263	34.49718991	11.15058888 0.17946003 0.123650181];
%p_vec = [130157.368705725,4812.72121015092,3.46221047687037,17051.6934979162,924.433870278525,0.0525778925170454,2.66701424433824,0.00349275110661883,0.293814247545723,-0.313775721113438,2.66655052022994,0.271673954221911,148.204532874920,1267.69556520898,0.0930171238155531,0.0476988301087838,15.0827998075039,13.5953314938244,0.152555049918779,0.378871764439884];
% p_vec = [148738.717846757,4548.90858891110,3.41045331607817,3926.00470046007,1068.37125514534,0.177073848269830,3.16327432106180,0.00384161224514325,0.280683310568376,-0.401392485117953,3.47971495413783,0.109924300168623,203.245457587307,435.177389949699,2.31008727717361,0.0597829489947634,0.0292426967153828,0.00299293793918784];
...
%New Fab acitivites/lipidA/phospholipid components are unlabeled/incorreclty labeled
%as the new initiation stuff
...
tables = struct;
tables.('param_table') = readtable('est_param','ReadRowNames',true);
...
for i = 1:length(param_names{1})
    param_struct.(param_names{1}{i}) = param_func_new_init(param_names{1}{i},i,opt_struct,tables);
end
...
parameterized_Combined_Pathway_Model = @(t,c) Combined_Pathway_Model_Base(t,c,param_struct,opt_struct);
