function dy = Combined_Pathway_Model_Base(t,y,param_list,opt_struct)
...
%Turning off C20 B-hydroxyacyl-ACP formation
%not necessary with kcats acting on C18 intermediates turned off.
%kcat4(9) = 0;
%k4_2f(9) = 0;
%k4_2r(9) = 0;
...
if strcmp(opt_struct.TesA_fitting_source,'Pf')
...
kcat8_un = kcat8(4).*[1,1,1,rel_FB*ratio_FB,0.9,0.289,0.34,0,0];%specificity of reaction with unsaturated acyl chains
...
kcat10_un = kcat10(5).*[1,1,1,1,1,0.125,0.0229,0,0];%specificity of reaction with unsaturated acyl chains
...
dy(11,:) = kcat3.*y(92,:) + kcat8(1).*y(104,:) + kcat8(2).*y(119,:) + kcat8(3).*y(134,:) + kcat8(4).*y(149,:)...
    ...
    + kcat8_un(4).*y(308,:)... % I added this, is it a mistake that it wasn't here?
;
