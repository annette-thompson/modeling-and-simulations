...
%% Main_Script
% Reorganized model: user only edits options and variables, contains ACC
% clear all
% close all
% clc
...
S.init_cond(1) = 1000; %s1 (ATP)
S.init_cond(10) = 0; %p4 (Malonyl-ACP)
S.init_cond(11) = 0; %p5 (CO2)
S.init_cond(2) = 500; %s2 (Bicarbonate)
...
S.init_cond(8) = 0; %p2 (Malonyl-CoA)
