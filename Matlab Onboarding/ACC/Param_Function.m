...
P.k1_4f = S.param_table{'k1_4f','parameter_values'}*S.scaling_factor_elon;
P.k1_4r = S.param_table{'k1_4r','parameter_values'}*S.scaling_factor_elon;
P.k1_5f = S.param_table{'k1_5f','parameter_values'}*S.scaling_factor_elon;
P.k1_5r = S.param_table{'k1_5r','parameter_values'}*S.scaling_factor_elon;

P.k3_5f = S.param_table{'k3_5f','parameter_values'}*S.scaling_factor_elon;
P.k3_5r = S.param_table{'k3_5r','parameter_values'}*S.scaling_factor_elon;
...
P.k8_8r = S.param_table{'k8_8r','parameter_values'};
...
P.kcat6 = P.kcat6.*ones(1,num_elong_steps);
...
% ACC
P.e1Ctot = S.enzyme_conc(1);
P.e1Btot = S.enzyme_conc(1);
P.e1ADtot = S.enzyme_conc(1);
