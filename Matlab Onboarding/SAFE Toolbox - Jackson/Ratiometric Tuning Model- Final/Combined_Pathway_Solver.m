...
%   Output:
%       obj: vector containing the SSE objective for the palmitic acid
%       equiv vs time data and the fatty acid profile. 

%All units are uM and seconds.

function [obj] = Combined_Pathway_Solver(p_vec,param_struct,enz_conc,time_range,init_cond)
...
'e10s3';'e10act';'e10actp4';'e8s3';'e8act';'e8actp4';...
'e10p4';'T_2';'e10_T2';'e8p4';'e8_T2';...
};
...
field29 = 'scaling_factor_aCoA_10'; val29 = p_vec(18); %scaling for FabB binding with aCoA in decarboxylation
...
obj(1) = LeastSquaresCalc(time_val,F_weighted,'Experimental_Dataset.csv');
% Experimental Data:
