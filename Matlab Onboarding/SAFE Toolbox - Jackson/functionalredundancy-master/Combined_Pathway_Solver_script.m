...
%p_vec = [1.0429    0.9692    1.1978    1.1943    0.9894    0.8970    0.9884    1.0871    0.3645    1.0668    0.9372    1.0797    1.2814    0.9807];
...
field17 = 'enzyme_conc'; val17 = [0 1 1 1 1 1 10 1 1 0];%Initial enzyme conentrations (ACC,FabD,FabH,FabG,FabZ,FabI,TesA,FabF,FabA,FabB)
...
elseif strcmp(plotopt,'palmitic')
    ...
    writetable(struct2table(param_struct), 'FinalKineticVals.xlsx')
end